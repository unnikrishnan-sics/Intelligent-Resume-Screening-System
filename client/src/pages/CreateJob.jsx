...
const CreateJob = () => {
    ...
    const onSubmit = async e => {
        ...
        // Convert requirements string to array (split by newline)
            ...
            <main className="dashboard-main">
                <div style={{ maxWidth: '800px', margin: '0 auto' }}>
                    <header style={{ marginBottom: '2.5rem', textAlign: 'center' }}>
                        <h1 style={{ fontSize: '2.5rem', marginBottom: '0.75rem', backgroundImage: 'linear-gradient(135deg, #6366f1 0%, #a855f7 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', display: 'inline-block' }}>Post a New Job</h1>
                        <p style={{ color: 'var(--text-muted)', fontSize: '1.1rem' }}>Create a compelling vacancy to attract top talent</p>
                    </header>
                    ...
                    <div className="card" style={{ padding: '2.5rem', border: '1px solid rgba(255,255,255,0.5)', boxShadow: '0 20px 25px -5px rgba(0, 0, 0, 0.05), 0 8px 10px -6px rgba(0, 0, 0, 0.01)' }}>
                        ...
                        <form onSubmit={onSubmit} style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem' }}>
                            ...
                            <div style={{ gridColumn: '1 / -1', marginTop: '1rem', display: 'flex', gap: '1rem', paddingTop: '2rem', borderTop: '1px solid #f1f5f9' }}>
                                ...
                                >
                                    {loading ? 'Posting Job...' : '✨ Post Job Vacancy'}
                                </button>
                            </div>
                        </form>
                    </div>

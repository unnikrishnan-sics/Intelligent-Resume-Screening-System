            ...
            <nav className={`navbar ${scrolled ? 'scrolled' : ''}`}>
                <div className="container navbar-content">
                    ...
                    <div className={`navbar-links ${isOpen ? 'active' : ''}`}>
                        ...
                        {user && (
                            <button onClick={handleLogoutClick} className="btn btn-sm btn-outline mobile-only" style={{ width: '100%', marginTop: '1rem' }}>Logout</button>
                        )}
                    </div>
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                                ...
                                >
                                    ...
                                    <div style={{ display: 'flex', flexDirection: 'column', lineHeight: 1.2 }}>
                                        ...
                                        <span style={{ fontWeight: '600', fontSize: '0.95rem' }}>{(user.name || 'User').split(' ')[0]}</span>
                                    </div>
                                </Link>
                                <button onClick={handleLogoutClick} className="btn btn-sm btn-outline desktop-only" style={{ padding: '0.5rem 1rem', fontSize: '0.9rem' }}>Logout</button>
                            </div>
                        )}
